...
RcppExport SEXP _quanteda_core_qatd_cpp_keyness(SEXP mtSEXP, SEXP measureSEXP, SEXP correctSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_quanteda_core_qatd_cpp_keyness", (DL_FUNC) &_quanteda_core_qatd_cpp_keyness, 3},
